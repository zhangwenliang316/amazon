			...
			<form id="regForm" method="post" action="doAction?action=register" ><!-- onsubmit="return checkForm(this)" -->
				<table>
					...
					<tr>
						...
						<td><input value="sa@sina.com"  id="email" class="text" type="text" name="email"  onfocus="FocusItem(this)" onblur="CheckItem(this);"/><span id="uemail"></span></td>
					</tr>
					<tr>
