...
<div id="header">
	<div class="login_menu">
		<div class="login_container">
			...
			<ul class="m_right">
				<c:choose>
					<c:when test="${user!=null }">
						<li><img src="images/icon_3.png"><a href="doShowCart"
				...
				<li><img src="images/icon_1.png"><a href="doQuery">首页</a></li>
			</ul>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function queryProducts(){
			var goodsName = $("#qname").val();
			$.ajax({
				type:"get",
				url:"doQueryGoods?goodsName=" + goodsName,
				dateType:"html",
				success:function(msg){
					if(msg==0){
						alert("搜索不到任何商品!");
					}else{
						$("#showQueryGoods").html(msg);
					}
				}
			})
		}
